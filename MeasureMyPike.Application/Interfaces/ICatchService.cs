...
{
    Catch AddCatch(byte[] image, string format, DateTime timeStamp,  string comment, Lure lure, int fishWeight, int fishLength, string lake, string coordinates, Double waterTemperature, Double airTemperature, string weather, string username, params string[] additionalInformation);
